...
@section('content')
    <div class="block-header">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="p-4">
                    <h3 class="page-title text-iranyekan">افزودن خدمت جدید </h3>
                </div>
            </div>
        </div>
    </div>
    <div class="clearfix">
        <div class="card">
            ...
            <div class="body">
                <form class="form-row" action="{{route('manager_service_store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <div class="alert alert-info">
                            <h5><i class="fa fa-info"></i> نکته:</h5>
                            <p>
                                خدماتی که بدون وابستگی ساخته میشونده به عنوان خدمات اصلی و شاخته اصلی قرار میگیرند
                            </p>
                        </div>
                    </div>
